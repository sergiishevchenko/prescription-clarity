        ...
        <div className={stepStyles.fieldStack}>
          ...
          <div className={stepStyles.field}>
            ...
            <input
              ...
              {...frequencyFieldRegister}
            />
            <div className="mt-2 sm:mt-4 grid grid-cols-1 gap-2.5 sm:gap-4 sm:grid-cols-3">
              {FREQUENCY_OPTIONS.map(({ value, label, description }) => {
                ...
                return (
                  <button
                    ...
                    className={`rounded-[14px] sm:rounded-[20px] border-2 px-3.5 py-2.5 sm:px-5 sm:py-4 text-left transition focus-visible:ring-4 focus-visible:ring-[#1479FF]/20 focus-visible:outline-none ${
                      isActive
          ...
          <div className={stepStyles.field}>
            ...
            <input
              ...
              {...mealTimingFieldRegister}
            />
            <div className="mt-2 sm:mt-4 grid grid-cols-1 gap-2.5 sm:gap-4 md:grid-cols-2">
